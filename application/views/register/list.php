            ...
            <td class="hidden"></td>
                          ...
                          <td><?= $reg->email; ?></td>
                             <td><?= $reg->mobile; ?></td>
                              ...
                              <td style="width:15%"><?= anchor(site_url('register/edit/' . $reg->register_id), 'Edit', array('class' => 'btn btn-primary btn-sm')) . ' ' . anchor(site_url('register/delete/' . $reg->register_id), 'Delete', array('class' => 'btn btn-danger btn-sm')) ?>
            </td>
